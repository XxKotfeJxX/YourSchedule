...
_METHOD_PARTS: dict[str, list[str]] = {
    "_build_assignments_editor__impl": [
        "_build_assignments_editor__impl.pyfrag",
    ],
    "_build_components_editor__impl": [
        "_build_components_editor__impl.pyfrag",
    ],
    "_build_plan_editor__impl": [
        "_build_plan_editor__impl.pyfrag",
    ],
    "_build_plans_tab__impl": [
        "_build_plans_tab__impl.pyfrag",
    ],
    "_create_assignment__impl": [
        "_create_assignment__impl.pyfrag",
    ],
    "_create_component__impl": [
        "_create_component__impl.pyfrag",
    ],
    "_create_plan__impl": [
        "_create_plan__impl.pyfrag",
    ],
    "_delete_assignment__impl": [
        "_delete_assignment__impl.pyfrag",
    ],
    "_delete_component__impl": [
        "_delete_component__impl.pyfrag",
    ],
    "_delete_plan__impl": [
        "_delete_plan__impl.pyfrag",
    ],
    "_format_optional_ref__impl": [
        "_format_optional_ref__impl.pyfrag",
    ],
    "_load_assignments__impl": [
        "_load_assignments__impl.pyfrag",
    ],
    "_load_components__impl": [
        "_load_components__impl.pyfrag",
    ],
    "_load_plan_reference_data__impl": [
        "_load_plan_reference_data__impl.pyfrag",
    ],
    "_load_plans__impl": [
        "_load_plans__impl.pyfrag",
    ],
    "_on_assignment_select__impl": [
        "_on_assignment_select__impl.pyfrag",
    ],
    "_on_component_select__impl": [
        "_on_component_select__impl.pyfrag",
    ],
    "_on_plan_select__impl": [
        "_on_plan_select__impl.pyfrag",
    ],
    "_refresh_assignment_target_controls__impl": [
        "_refresh_assignment_target_controls__impl.pyfrag",
    ],
    "_resolve_target_ids__impl": [
        "_resolve_target_ids__impl.pyfrag",
    ],
    "_sync_assignment__impl": [
        "_sync_assignment__impl.pyfrag",
    ],
    "_sync_plan__impl": [
        "_sync_plan__impl.pyfrag",
    ],
    "_target_display__impl": [
        "_target_display__impl.pyfrag",
    ],
    "_update_assignment__impl": [
        "_update_assignment__impl.pyfrag",
    ],
    "_update_component__impl": [
        "_update_component__impl.pyfrag",
    ],
    "_update_plan__impl": [
        "_update_plan__impl.pyfrag",
    ],
}
